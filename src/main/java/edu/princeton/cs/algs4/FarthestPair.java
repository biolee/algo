...
/**
 * The <tt>FarthestPair</tt> data type computes the farthest pair of points in a set of <em>n</em>
...
public class FarthestPair {
  ...
  /**
   * Unit tests the <tt>FarthestPair</tt> data type. Reads in an integer <tt>n</tt> and <tt>n</tt>
   ...
   *
   * @return one of the two points in the farthest pair of points; <tt>null</tt> if no such point
   ...
   *
   * @return the other point in the farthest pair of points <tt>null</tt> if no such point (because
