...
/**
 * The <tt>LinearProgramming</tt> class represents a data type for solving a linear program of the
 * form { max cx : Ax <= b, x >= 0 }, where A is a m-by-n matrix, b is an m-length vector, and c is
 * an n-length vector. For simplicity, we assume that A is of full rank and that b >= 0 so that x =
 * 0 is a basic feasible soution.
 *
...
public class LinearProgramming {
  ...
  /**
   * Determines an optimal solution to the linear program { max cx : Ax <= b, x >= 0 }, where A is a
