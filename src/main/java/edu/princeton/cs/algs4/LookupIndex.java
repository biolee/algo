 ...
 * http://algs4.cs.princeton.edu/35applications/aminoI.csv
...
/**
 * The <tt>LookupIndex</tt> class provides a data-driven client for reading in a key-value pairs
 * from a file; then, printing the values corresponding to the keys found on standard input. Keys
 * are strings; values are lists of strings. The separating delimiter is taken as a command-line
