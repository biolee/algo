/**
 * **************************************************************************** Compilation: javac
 * QuickX.java Execution: java QuickX N Dependencies: StdOut.java StdIn.java
 *
...
/**
 * The <tt>QuickX</tt> class provides static methods for sorting an array using an optimized version
 * of quicksort (using Bentley-McIlroy 3-way partitioning, Tukey's ninther, and cutoff to insertion
 * sort).
 *
