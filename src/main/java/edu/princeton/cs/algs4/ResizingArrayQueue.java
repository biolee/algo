 ...
 * StdOut.java Data files: http://algs4.cs.princeton.edu/13stacks/tobe.txt
 *
...
/**
 * The <tt>ResizingArrayQueue</tt> class represents a first-in-first-out (FIFO) queue of generic
