...
/**
 * The <tt>Complex</tt> class represents a complex number. Complex numbers are immutable: their
...
public class Complex {
  ...
  /**
   * Returns the phase of this complex number. This quantity is also known as the <em>ange</em> or
   * <em>argument</em>.
   *
