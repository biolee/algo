...
/**
 * The <tt>EdgeWeightedDirectedCycle</tt> class represents a data type for determining whether an
...
public class EdgeWeightedDirectedCycle {
  ...
  /**
   * Determines whether the edge-weighted digraph <tt>G</tt> has a directed cycle and, if so, finds
   * such a cycle.
   *
   ...
   *
   * @return <tt>true</tt> if the edge-weighted digraph has a directed cycle, <tt>false</tt>
   *     otherwise
   */
  ...
  /**
   * Returns a directed cycle if the edge-weighted digraph has a directed cycle, and <tt>null</tt>
   * otherwise.
   *
