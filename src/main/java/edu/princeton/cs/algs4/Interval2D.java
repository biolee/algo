...
/**
 * The <tt>Interval2D</tt> class represents a closed two-dimensional interval, which represents all
 * points (x, y) with both xmin <= x <= xmax and ymin <= y <= ymax. Two-dimensional intervals are
 * immutable: their values cannot be changed after they are created. The class <code>Interval2D
 * </code> includes methods for checking whether a two-dimensional interval contains a point and
