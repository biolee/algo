/**
 * **************************************************************************** Compilation: javac
 * Stack.java Execution: java Stack < input.txt Dependencies: StdIn.java StdOut.java
 *
...
/**
 * The <tt>Stack</tt> class represents a last-in-first-out (LIFO) stack of generic items. It
 ...
 * class. The <em>push</em>, <em>pop</em>, <em>peek</em>, <em>size</em>, and <em>is-empty</em>
 * operations all take constant time in the worst case.
 *
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/13stacks">Section
