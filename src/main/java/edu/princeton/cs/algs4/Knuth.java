...
/**
 * The <tt>Knuth</tt> class provides a client for reading in a sequence of strings and
...
public class Knuth {
   ...
   * <tt>Math.random()</tt> generates independent and uniformly distributed numbers between 0 and
   * 1).
   *
