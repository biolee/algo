/**
 * **************************************************************************** Compilation: javac
 * DirectedDFS.java Execution: java DirectedDFS V E Dependencies: Digraph.java Bag.java In.java
 * StdOut.java Data files: http://algs4.cs.princeton.edu/42digraph/tinyDG.txt
 *
 * <p>Determine single-source or multiple-source reachability in a digraph using depth first
 * algo.search. Runs in O(E + V) time.
 *
...
/**
 * The <tt>DirectedDFS</tt> class represents a data type for determining the vertices reachable from
