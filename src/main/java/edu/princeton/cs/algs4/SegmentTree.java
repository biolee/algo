...
/**
 * The <tt>SegmentTree</tt> class is an structure for efficient algo.search of cummulative data. It
 ...
 *
 * <p>Also it has been develop with <tt>LazyPropagation</tt> for range updates, which means when you
...
public class SegmentTree {
   ...
   * v. exit
   *
   * <p>Example: <<init <<set 1 2 3 4 5 6 <<rsq 1 3 >>Sum from 1 to 3 = 6 <<rmq 1 3 >>Min from 1 to
   * 3 = 1 <<input up 1 3 >>[3,2,3,4,5,6]
   *
   * @param args
   */
