...
/**
 * The <tt>AcyclicSP</tt> class represents a data type for solving the single-source shortest paths
...
public class AcyclicSP {
  ...
  /**
   * Computes a shortest paths tree from <tt>s</tt> to every other vertex in the directed acyclic
   * graph <tt>G</tt>.
   *
