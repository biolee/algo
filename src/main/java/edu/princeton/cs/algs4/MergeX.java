...
/**
 * The <tt>MergeX</tt> class provides static methods for sorting an array using an optimized version
 * of mergesort.
 *
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/22mergesort">Section
