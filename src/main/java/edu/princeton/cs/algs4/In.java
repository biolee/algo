 ...
 * \r\n, and Unicode hex code points 0x2028, 0x2029, 0x0085; see <tt><a
 * href="http://www.docjar.com/html/api/java/util/Scanner.java.html">Scanner.java</a></tt> (NB: Java
...
public final class In {
  ...
  /**
   * Initializes an input stream from a given {@link Scanner} source; use with <tt>new
   * Scanner(String)</tt> to read from a string.
   *
   ...
   * #hasNextChar()}.
   *
   * @return <tt>true</tt> if this input stream is empty; <tt>false</tt> otherwise
   */
