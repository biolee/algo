...
/**
 * The <tt>StaticSETofInts</tt> class represents a set of integers. It supports searching for a
 * given integer is in the set. It accomplishes this by keeping the set of integers in a sorted
 * array and using binary algo.search to find the given integer.
 *
...
public class StaticSETofInts {
  ...
  /**
   * Returns either the index of the algo.search key in the sorted array (if the key is in the set)
