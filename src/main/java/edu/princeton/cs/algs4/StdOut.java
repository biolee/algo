 ...
 *
 * <p><b>Getting started.</b> To use this class, you must have <tt>StdOut.class</tt> in your Java
 * classpath. If you used our autoinstaller, you should be all set. Otherwise, download <a href =
 * "http://introcs.cs.princeton.edu/java/stdlib/StdOut.java">StdOut.java</a> and put a copy in your
 * working directory.
 *
 * <p>Here is an example program that uses <code>StdOut</code>:
 *
 * <pre>
 ...
 *  </pre>
 *
 * <p><b>Differences with System.out.</b> The behavior of <code>StdOut</code> is similar to that of
 * {@link System#out}, but there are a few subtle differences:
 *
 * <ul>
 *   <li><code>StdOut</code> coerces the character-set encoding to UTF-8, which is a standard
 *       character encoding for Unicode.
 *   <li><code>StdOut</code> coerces the locale to {@link Locale#US}, for consistency with {@link
 *       StdIn}, {@link Double#parseDouble(String)}, and floating-point literals.
 *   <li><code>StdOut</code> <em>flushes</em> standard output after each call to <code>print()
 *       </code> so that text will appear immediately in the terminal.
 * </ul>
 *
