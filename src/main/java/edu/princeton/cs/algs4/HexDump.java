...
/**
 * The <tt>HexDump</tt> class provides a client for displaying the contents of a binary file in
 * hexadecimal.
 *
 ...
 * Unix utilities <tt>od</tt> (octal dump) and <tt>hexdump</tt> (hexadecimal dump).
 *
 * <p>
 *
