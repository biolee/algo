/**
 * **************************************************************************** Compilation: javac
 * TST.java Execution: java TST < words.txt Dependencies: StdIn.java
 *
 * <p>Symbol table with string keys, implemented using a ternary algo.search trie (TST).
 *
...
/**
 * The <tt>TST</tt> class represents an symbol table of key-value pairs, with string keys and
 ...
 *
 * <p>This implementation uses a ternary algo.search trie.
 *
...
public class TST<Value> {
  ...
  /**
   * Returns the string in the symbol table that is the longest prefix of <tt>query</tt>, or
