 ...
 *
 * <p>% java BinaryIn http://introcs.cs.princeton.edu/cover.jpg output.jpg
 *
 * <p>****************************************************************************
 */
 ...
 * either one bit at a time (as a <tt>boolean</tt>), 8 bits at a time (as a <tt>byte</tt> or
 * <tt>char</tt>), 16 bits at a time (as a <tt>short</tt>), 32 bits at a time (as an <tt>int</tt> or
 * <tt>float</tt>), or 64 bits at a time (as a <tt>double</tt> or <tt>long</tt>).
 *
 ...
 *
 * <p>The client should not intermix calls to <tt>BinaryIn</tt> with calls to <tt>In</tt>; otherwise
...
public final class BinaryIn {
  ...
  /**
   * Unit tests the <tt>BinaryIn</tt> data type. Reads the name of a file or URL (first command-line
   ...
   *
   * @return <tt>true</tt> if this binary input stream exists; <tt>false</tt> otherwise
   */
   ...
   *
   * @return <tt>true</tt> if this binary input stream is empty; <tt>false</tt> otherwise
   */
