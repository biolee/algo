...
/**
 * The <tt>AssignmentProblem</tt> class represents a data type for computing an optimal solution to
 ...
 *
 * <p>See also {@link WeightedBipartiteMatching}, which solves the problem in O(<em>E V</em> log
 * <em>V</em>) time in the worst case for bipartite graphs with <em>V</em> vertices and <em>E</em>
 * edges.
 *
...
public class AssignmentProblem {
  ...
  /**
   * Unit tests the <tt>AssignmentProblem</tt> data type. Takes a command-line argument n; creates a
