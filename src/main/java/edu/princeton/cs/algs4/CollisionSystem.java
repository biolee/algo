 ...
 * < input.txt (from a file) Dependencies: StdDraw.java Particle.java MinPQ.java
 *
...
/**
 * The <tt>CollisionSystem</tt> class represents a collection of particles moving in the unit box,
 * according to the laws of elastic collision. This event-based simulation relies on a priority
 * queue.
 *
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/61event">Section
...
public class CollisionSystem {
  ...
  /**
   * Unit tests the <tt>CollisionSystem</tt> data type. Reads in the particle collision system from
   * a standard input (or generates <tt>N</tt> random particles if a command-line integer is
