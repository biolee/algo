 ...
 * files: http://algs4.cs.princeton.edu/33balanced/tinyST.txt
 *
...
/**
 * The <code>AVLTreeST</code> class represents an ordered symbol table of generic key-value pairs.
 * It supports the usual <em>put</em>, <em>get</em>, <em>contains</em>, <em>delete</em>,
 * <em>size</em>, and <em>is-empty</em> methods. It also provides ordered methods for finding the
 * <em>minimum</em>, <em>maximum</em>, <em>floor</em>, and <em>ceiling</em>. It also provides a
 ...
 * java.util.Map}, this class uses the convention that values cannot be <code>null</code>
 * &mdash;setting the value associated with a key to <code>null</code> is equivalent to deleting the
 ...
 *
 * <p>This implementation requires that the key type implements the <code>Comparable</code>
 * interface and calls the <code>compareTo()</code> and method to compare two keys. It does not call
 * either <code>equals()</code> or <code>hashCode()</code>. The <em>put</em>, <em>get</em>,
...
public class AVLTreeST<Key extends Comparable<Key>, Value> {
   ...
   *     null</code> if the key is not in the symbol table
  ...
  /**
   * Returns value associated with the given key in the subtree or <code>null</code> if no such key.
   *
   * @param x the subtree
   * @param key the key
   * @return value associated with the given key in the subtree or <code>null</code> if no such key
   */
   ...
   *
   * @param key the key
   * @return <code>true</code> if the symbol table contains <code>key</code> and <code>false</code>
   *     otherwise
   * @throws NullPointerException if <code>key</code> is <code>null</code>
   */
   ...
   * (and its associated value) from this symbol table if the specified value is <code>null</code>.
   *
   * @param key the key
   * @param val the value
   * @throws NullPointerException if <code>key</code> is <code>null</code>
   ...
   * associated value) from this symbol table if the specified value is <code>null</code>.
   *
   * @param x the subtree
   * @param key the key
   * @param val the value
  ...
  /**
   * Returns the largest key in the symbol table less than or equal to <code>key</code>.
   *
   * @param key the key
   * @return the largest key in the symbol table less than or equal to <code>key</code>
   * @throws NoSuchElementException if the symbol table is empty
   * @throws NullPointerException if <code>key</code> is <code>null</code>
   */
  ...
  /**
   * Returns the smallest key in the symbol table greater than or equal to <code>key</code>.
   *
   * @param key the key
   * @return the smallest key in the symbol table greater than or equal to <code>key</code>
   * @throws NoSuchElementException if the symbol table is empty
   * @throws NullPointerException if <code>key</code> is <code>null</code>
   */
   ...
   * @throws IllegalArgumentException unless <code>k</code> is between 0 and <code> size() -1
   *     </code>
   */
  ...
  /**
   * Returns the number of keys in the symbol table strictly less than <code>key</code>.
   *
   * @param key the key
   * @return the number of keys in the symbol table strictly less than <code>key</code>
   * @throws NullPointerException if <code>key</code> is <code>null</code>
   */
   ...
   * @return all keys in the symbol table between <code>lo</code> (inclusive) and <code>hi</code>
   *     (exclusive)
   * @throws NullPointerException if either <code>lo</code> or <code>hi</code> is <code>null</code>
   */
  ...
  /**
   * Adds the keys between <code>lo</code> and <code>hi</code> in the subtree to the <code>queue
   * </code>.
   *
   * @param x the subtree
   * @param queue the queue
   ...
   *
   * @return the number of keys in the symbol table between <code>lo</code> (inclusive) and <code>hi
   *     </code> (exclusive)
   * @throws NullPointerException if either <code>lo</code> or <code>hi</code> is <code>null</code>
   */
