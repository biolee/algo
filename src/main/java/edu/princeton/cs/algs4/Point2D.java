...
/**
 * The <tt>Point</tt> class is an immutable data type to encapsulate a two-dimensional point with
...
public final class Point2D implements Comparable<Point2D> {
   ...
   * @throws IllegalArgumentException if either <tt>x</tt> or <tt>y</tt> is <tt>Double.NaN</tt>,
   ...
   *
   * @param that the other point
   * @return the value <tt>0</tt> if this string is equal to the argument string (precisely when
   *     <tt>equals()</tt> returns <tt>true</tt>); a negative integer if this point is less than the
