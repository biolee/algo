...
/**
 * The <tt>Cycle</tt> class represents a data type for determining whether an undirected graph has a
 * cycle. The <em>hasCycle</em> operation determines whether the graph has a cycle and, if so, the
...
public class Cycle {
  ...
  /**
   * Determines whether the undirected graph <tt>G</tt> has a cycle and, if so, finds such a cycle.
   *
   ...
   *
   * @return a cycle if the graph <tt>G</tt> has a cycle, and <tt>null</tt> otherwise
   */
