...
/**
 * The <tt>EulerianPath</tt> class represents a data type for finding an Eulerian path in a graph.
 * An <em>Eulerian path</em> is a path (not necessarily simple) that uses every edge in the graph
 * exactly once.
 *
...
public class EulerianPath {
   ...
   *
   * @return <tt>true</tt> if the graph has an Eulerian path; <tt>false</tt> otherwise
   */
