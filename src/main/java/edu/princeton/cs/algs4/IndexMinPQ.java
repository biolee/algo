...
/**
 * The <tt>IndexMinPQ</tt> class represents an indexed priority queue of generic keys. It supports
 ...
 * queue, an integer between 0 and maxN-1 is associated with each key&mdash;the client uses this
 * integer to specify which key to delete or change. It also supports methods for peeking at the
 ...
 * specified capacity.
 *
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/24pq">Section 2.4</a>
...
public class IndexMinPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
  ...
  /**
   * Initializes an empty indexed priority queue with indices between <tt>0</tt> and <tt>maxN -
   * 1</tt>.
   *
   * @param maxN the keys on this priority queue are index from <tt>0</tt> <tt>maxN - 1</tt>
   ...
   *
   * @param i an index
   * @return <tt>true</tt> if <tt>i</tt> is an index on this priority queue; <tt>false</tt>
   *     otherwise
   ...
   * @throws IndexOutOfBoundsException unless 0 &le; <tt>i</tt> &lt; <tt>maxN</tt>
   * @throws IllegalArgumentException if there already is an item associated with index <tt>i</tt>
   */
   ...
   * iterator doesn't implement <tt>remove()</tt> since it's optional.
   *
