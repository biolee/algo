 ...
 *
 * <p>A symbol table implemented with a binary algo.search tree.
 *
 ...
 * symbol table.
 *
 * <p>This implementation uses an (unbalanced) binary algo.search tree. It requires that the key
 * type implements the <tt>Comparable</tt> interface and calls the <tt>compareTo()</tt> and method
 * to compare two keys. It does not call either <tt>equals()</tt> or <tt>hashCode()</tt>. The
 ...
 *
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/32bst">Section
 ...
 * RedBlackBST}, {@link SeparateChainingHashST}, and {@link LinearProbingHashST}, <i>Algorithms, 4th
