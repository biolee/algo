...
/**
 * The <tt>LongestCommonSubstring</tt> class provides a {@link SuffixArray} client for computing the
 ...
 * "http://algs4.cs.princeton.edu/63suffix/LongestCommonSubstringConcatenate.java.html">LongestCommonSubstringConcatenate.java</a>.
 *
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/63suffix">Section
...
public class LongestCommonSubstring {
   ...
   * @return the longest common string that appears as a substring in both <tt>s</tt> and
   *     <tt>t</tt>; the empty string if no such string
   */
  ...
  /**
   * Unit tests the <tt>lcs()</tt> method. Reads in two strings from files specified as command-line
