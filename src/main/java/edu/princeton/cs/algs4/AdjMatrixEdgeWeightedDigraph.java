...
/**
 * The <tt>AdjMatrixEdgeWeightedDigraph</tt> class represents a edge-weighted digraph of vertices
...
public class AdjMatrixEdgeWeightedDigraph {
  ...
  /**
   * Initializes an empty edge-weighted digraph with <tt>V</tt> vertices and 0 edges. param V the
   * number of vertices
   *
  ...
  /**
   * Initializes a random edge-weighted digraph with <tt>V</tt> vertices and <em>E</em> edges. param
   * V the number of vertices param E the number of edges
   *
   * @throws IllegalArgumentException if <tt>V</tt> < 0
  ...
  /**
   * Adds the directed edge <tt>e</tt> to the edge-weighted digraph (if there is not already an edge
