 ...
 * StdOut.java In.java Data files: http://algs4.cs.princeton.edu/42digraph/tinyDG.txt
...
/**
 * The <tt>DirectedCycle</tt> class represents a data type for determining whether a digraph has a
