...
/**
 * The <tt>EulerianCycle</tt> class represents a data type for finding an Eulerian cycle or path in
 * a graph. An <em>Eulerian cycle</em> is a cycle (not necessarily simple) that uses every edge in
 * the graph exactly once.
 *
 * <p>This implementation uses a nonrecursive depth-first algo.search. The constructor runs in
...
public class EulerianCycle {
  ...
  public EulerianCycle(Graph G) {
    ...
    // greedily algo.search through edges in iterative DFS style
   ...
   *
   * @return the sequence of vertices on an Eulerian cycle; <tt>null</tt> if no such cycle
   */
   ...
   *
   * @return <tt>true</tt> if the graph has an Eulerian cycle; <tt>false</tt> otherwise
   */
