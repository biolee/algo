...
/**
 * The <tt>Transaction</tt> class is an immutable data type to encapsulate a commercial transaction
...
public class Transaction implements Comparable<Transaction> {
   ...
   * @throws IllegalArgumentException if <tt>amount</tt> is <tt>Double.NaN</tt>,
