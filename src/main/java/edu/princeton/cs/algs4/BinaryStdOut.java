 ...
 * <tt>double</tt>) to sequences of bits and writing them to standard output. Uses big-endian
 * (most-significant byte first).
 *
 * <p>The client must <tt>flush()</tt> the output stream when finished writing bits.
 *
 * <p>The client should not intermixing calls to <tt>BinaryStdOut</tt> with calls to <tt>StdOut</tt>
 * or <tt>System.out</tt>; otherwise unexpected behavior will result.
 *
