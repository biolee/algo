...
/**
 * The <tt>Edge</tt> class represents a weighted edge in an {@link EdgeWeightedGraph}. Each edge
...
public class Edge implements Comparable<Edge> {
  ...
  /**
   * Initializes an edge between vertices <tt>v</tt> and <tt>w</tt> of the given <tt>weight</tt>.
   *
   * @param v one vertex
  ...
  /**
   * Compares two edges by weight. Note that <tt>compareTo()</tt> is not consistent with
   * <tt>equals()</tt>, which uses the reference equality implementation inherited from
   * <tt>Object</tt>.
   *
