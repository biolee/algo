...
/**
 * The <code>PatriciaST</code> class provides an implementation of an unordered symbol table of
 * key-value pairs, with the restriction that the key is of class {@link String}. It supports the
 ...
 * cannot be <code>null</code>&mdash;setting the value associated with a key to <code>null</code> is
 ...
 * this symbol table class can only accommodate keys of class {@link String}. This unfortunate
 * restriction stems from a limitation in Java. Although Java provides excellent support for generic
...
public class PatriciaST<Value> {
  ...
  /**
   * Unit tests the <code>PatriciaST</code> data type. This test fixture runs a series of tests on a
   ...
   * then its associated value becomes updated. If the value provided is <code>null</code>, then the
   * key becomes removed from the symbol table.
   *
   * @param key the key
   * @param val the value
  ...
  /**
   * Returns <code>true</code> if the key-value pair, specified by the given key, exists within the
   * symbol table.
   *
   * @param key the key
   * @return <code>true</code> if this symbol table contains the given <code>key</code> and <code>
   ...
   *
   * @return <code>true</code> if this symbol table is empty and <code>false</code> otherwise
   */
  boolean isEmpty() {
    return count == 0;
  }
  ...
  /**
   * Returns all keys in the symbol table as an <code>Iterable</code>. To iterate over all of the
   * keys in the symbol table named <code>st</code>, use the foreach notation: <code>
   * for (Key key : st.keys())</code>.
   *
