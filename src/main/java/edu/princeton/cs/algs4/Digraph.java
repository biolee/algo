 ...
 * files: http://algs4.cs.princeton.edu/42digraph/tinyDG.txt
 *
...
/**
 * The <tt>Digraph</tt> class represents a directed graph of vertices named 0 through <em>V</em> -
 * 1. It supports the following two primary operations: add an edge to the digraph, iterate over all
 * of the vertices adjacent from a given vertex. Parallel edges and self-loops are permitted.
 *
