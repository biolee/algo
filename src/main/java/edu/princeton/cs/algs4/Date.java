...
/**
 * The <tt>Date</tt> class is an immutable data type to encapsulate a date (day, month, and year).
 *
...
public class Date implements Comparable<Date> {
   ...
   * Compares two dates chronologically.
   *
   * @return the value <tt>0</tt> if the argument date is equal to this date; a negative integer if
