...
/**
 * The <tt>IndexMaxPQ</tt> class represents an indexed priority queue of generic keys. It supports
 ...
 * integer to specify which key to delete or change. It also supports methods for peeking at a
