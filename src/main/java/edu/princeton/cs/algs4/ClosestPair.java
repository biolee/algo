/**
 * **************************************************************************** Compilation: javac
 * ClosestPair.java Execution: java ClosestPair < input.txt Dependencies: Point2D.java
 *
...
/**
 * The <tt>ClosestPair</tt> data type computes a closest pair of points in a set of <em>n</em>
 * points in the plane and provides accessor methods for getting the closest pair of points and the
 ...
 *
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/99hull">Section
...
public class ClosestPair {
   ...
   * @throws NullPointerException if <tt>points</tt> is <tt>null</tt> or if any entry in
   *     <tt>points[]</tt> is <tt>null</tt>
   */
  ...
  /**
   * Unit tests the <tt>ClosestPair</tt> data type. Reads in an integer <tt>n</tt> and <tt>n</tt>
   ...
   *
   * @return one of the two points in the closest pair of points; <tt>null</tt> if no such point
   ...
   *
   * @return the other point in the closest pair of points <tt>null</tt> if no such point (because
   ...
   *     <tt>Double.POSITIVE_INFINITY</tt> if no such pair of points exist (because there are fewer
   *     than 2 points)
   */
