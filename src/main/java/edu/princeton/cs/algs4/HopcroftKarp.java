...
/**
 * The <tt>HopcroftKarp</tt> class represents a data type for computing a <em>maximum (cardinality)
 ...
 * "http://algs4.cs.princeton.edu/65reductions/BipartiteMatchingToMaxflow.java.html">BipartiteMatchingToMaxflow</a>,
 * which solves the problem in O(<em>E V</em>) time via a reduction to the maxflow problem.
 *
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/65reductions">Section
...
public class HopcroftKarp {
  ...
  /**
   * Unit tests the <tt>HopcroftKarp</tt> data type. Takes three command-line arguments <tt>V1</tt>,
   * <tt>V2</tt>, and <tt>E</tt>; creates a random bipartite graph with <tt>V1</tt> + <tt>V2</tt>
   * vertices and <tt>E</tt> edges; computes a maximum matching and minimum vertex cover; and prints
   * the results.
   */
  ...
  private boolean hasAugmentingPath(Graph G) {
    ...
    // breadth-first algo.search (starting from all unmatched vertices on one side of bipartition)
   ...
   *
   * @param v the vertex
   * @return the vertex to which vertex <tt>v</tt> is matched in the maximum matching; <tt>-1</tt>
   *     if the vertex is not matched
   ...
   *
   * @param v the vertex
   * @return <tt>true</tt> if vertex <tt>v</tt> is matched in maximum matching; <tt>false</tt>
   *     otherwise
   * @throws IllegalArgumentException unless <tt>0 &le; v &lt; V</tt>
   */
   ...
   * vertex is matched).
   *
   * @return <tt>true</tt> if the graph contains a perfect matching; <tt>false</tt> otherwise
   */
   ...
   *
   * @param v the vertex
   * @return <tt>true</tt> if vertex <tt>v</tt> is in the minimum vertex cover; <tt>false</tt>
   *     otherwise
   * @throws IllegalArgumentException unless <tt>0 &le; v &lt; V</tt>
   */
