 ...
 * input, either one bit at a time (as a <tt>boolean</tt>), 8 bits at a time (as a <tt>byte</tt> or
 ...
 *
 * <p>The client should not intermix calls to <tt>BinaryStdIn</tt> with calls to <tt>StdIn</tt> or
 * <tt>System.in</tt>; otherwise unexpected behavior will result.
 *
...
public final class BinaryStdIn {
  ...
  /**
   * Reads the next 8 bits from standard input and return as an 8-bit char. Note that <tt>char</tt>
