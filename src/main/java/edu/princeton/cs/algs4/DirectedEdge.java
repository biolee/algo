...
/**
 * The <tt>DirectedEdge</tt> class represents a weighted edge in an {@link EdgeWeightedDigraph}.
 * Each edge consists of two integers (naming the two vertices) and a real-value weight. The data
...
public class DirectedEdge {
  ...
  /**
   * Initializes a directed edge from vertex <tt>v</tt> to vertex <tt>w</tt> with the given
   * <tt>weight</tt>.
   *
