...
/**
 * The <tt>GaussianElimination</tt> data type provides methods to solve a linear system of equations
 ...
 * <a href =
 * "http://algs4.cs.princeton.edu/99scientific/GaussianEliminationLite.java.html">GaussianEliminationLite.java</a>
 ...
 * 9.9</a> <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.
 *
...
public class GaussianElimination {
   ...
   * @throws IllegalArgumentException if the dimensions disagree, i.e., the length of <tt>b</tt>
   *     does not equal <tt>m</tt>
   */
   ...
   *     <tt>null</tt> if no such solution
   */
   ...
   * <em>b</em>.
   *
   * @return <tt>true</tt> if there exists a solution to the linear system of equations <em>Ax</em>
   *     = <em>b</em>; <tt>false</tt> otherwise
   */
