 ...
 * StdIn.java Data files: http://algs4.cs.princeton.edu/21sort/tiny.txt
...
/**
 * The <tt>BinaryInsertion</tt> class provides a static method for sorting an array using an
...
public class BinaryInsertion {
  ...
  public static void sort(Comparable[] a) {
    ...
    for (int i = 1; i < n; i++) {
      ...
      // binary algo.search to determine index j at which to insert a[i]
      Comparable v = a[i];
      int lo = 0, hi = i;
      while (lo < hi) {
        int mid = lo + (hi - lo) / 2;
