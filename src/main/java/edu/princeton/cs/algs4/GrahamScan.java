/**
 * **************************************************************************** Compilation: javac
 * GrahamaScan.java Execution: java GrahamScan < input.txt Dependencies: Point2D.java
 *
...
/**
 * The <tt>GrahamScan</tt> data type provides methods for computing the convex hull of a set of
 ...
 *
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/99scientific">Section
...
public class GrahamScan {
  ...
  public GrahamScan(Point2D[] pts) {
    ...
    int k1;
    for (k1 = 1; k1 < n; k1++) if (!points[0].equals(points[k1])) break;
    if (k1 == n) return; // all points equal

    // find index k2 of first point not collinear with points[0] and points[k1]
    int k2;
    for (k2 = k1 + 1; k2 < n; k2++) if (Point2D.ccw(points[0], points[k1], points[k2]) != 0) break;
  ...
  /**
   * Unit tests the <tt>GrahamScan</tt> data type. Reads in an integer <tt>n</tt> and <tt>n</tt>
   * points (specified by their <em>x</em>- and <em>y</em>-coordinates) from standard input;
   * computes their convex hull; and prints out the points on the convex hull to standard output.
   */
