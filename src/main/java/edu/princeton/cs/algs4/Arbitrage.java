 ...
 * DirectedEdge.java BellmanFordSP.java Data file: http://algs4.cs.princeton.edu/44sp/rates.txt
 *
...
/**
 * The <tt>Arbitrage</tt> class provides a client that finds an arbitrage opportunity in a currency
