 ...
 *
 * <p>- This library allows you to set and get the pseudorandom number seed.
 *
...
public final class StdRandom {
   ...
   * @return <tt>true</tt> with probability <tt>p</tt> and <tt>false</tt> with probability
   *     <tt>p</tt>
   ...
   *
   * @return <tt>true</tt> with probability 1/2 and <tt>false</tt> with probability 1/2
   */
   ...
   * @return a random integer from a geometric distribution with success probability <tt>p</tt>; or
   *     <tt>Integer.MAX_VALUE</tt> if <tt>p</tt> is (nearly) equal to <tt>1.0</tt>.
   * @throws IllegalArgumentException unless <tt>p >= 0.0</tt> and <tt>p <= 1.0</tt>
   */
   ...
   * @return a random integer from a discrete distribution: <tt>i</tt> with probability
   *     <tt>probabilities[i]</tt>
   ...
   * @return a random integer from a discrete distribution: <tt>i</tt> with probability proportional
   *     to <tt>frequencies[i]</tt>
