 ...
 *
 * <p>Even though this implementation include the method <tt>equals()</tt>, it does not support the
 * method <tt>hashCode()</tt> because sets are mutable.
 *
 * <p>This implementation uses a balanced binary algo.search tree. It requires that the key type
 ...
 * time.
 *
 * <p>This implementation uses a balanced binary algo.search tree. It requires that For additional
 * documentation, see <a href="http://algs4.cs.princeton.edu/35applications">Section 3.5</a> of
...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
   ...
   *
   * @param key the key
   * @return <tt>true</tt> if this set contains <tt>key</tt>; <tt>false</tt> otherwise
   * @throws NullPointerException if <tt>key</tt> is <tt>null</tt>
   */
   ...
   * different generic types. This is consistent with the behavior of <tt>equals()</tt> within
   * Java's Collections framework.
   *
   * @param other the other set
   * @return <tt>true</tt> if this set equals <tt>other</tt>; <tt>false</tt> otherwise
   */
  @Override
