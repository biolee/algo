 ...
 *
 * <p>The functions all throw a NullPointerException if the array passed in is null.
 *
...
public final class StdStats {
   ...
   *
   * @param a the array
   * @return the maximum value in the array <tt>a[]</tt>; <tt>Double.NEGATIVE_INFINITY</tt> if no
   *     such value
   */
   ...
   * @return the maximum value in the subarray <tt>a[lo..hi]</tt>; <tt>Double.NEGATIVE_INFINITY</tt>
   *     if no such value
   */
   ...
   *
   * @param a the array
   * @return the maximum value in the array <tt>a[]</tt>; <tt>Integer.MIN_VALUE</tt> if no such
   *     value
   */
   ...
   *
   * @param a the array
   * @return the minimum value in the array <tt>a[]</tt>; <tt>Double.POSITIVE_INFINITY</tt> if no
   *     such value
   */
   ...
   * @param lo the left endpoint of the subarray (inclusive)
   * @param hi the right endpoint of the subarray (inclusive)
   * @return the maximum value in the subarray <tt>a[lo..hi]</tt>; <tt>Double.POSITIVE_INFINITY</tt>
   *     if no such value
   */
   ...
   *
   * @param a the array
   * @return the minimum value in the array <tt>a[]</tt>; <tt>Integer.MAX_VALUE</tt> if no such
   *     value
   */
   ...
   *
   * @param a the array
   * @return the average value in the array <tt>a[]</tt>; <tt>Double.NaN</tt> if no such value
   */
   ...
   * @param lo the left endpoint of the subarray (inclusive)
   * @param hi the right endpoint of the subarray (inclusive)
   * @return the average value in the subarray <tt>a[lo..hi]</tt>; <tt>Double.NaN</tt> if no such
   *     value
   */
   ...
   *
   * @param a the array
   * @return the sample variance in the array <tt>a[]</tt>; <tt>Double.NaN</tt> if no such value
   */
   ...
   * @param lo the left endpoint of the subarray (inclusive)
   * @param hi the right endpoint of the subarray (inclusive)
   * @return the sample variance in the subarray <tt>a[lo..hi]</tt>; <tt>Double.NaN</tt> if no such
   *     value
   */
   ...
   *
   * @param a the array
   * @return the population variance in the array <tt>a[]</tt>; <tt>Double.NaN</tt> if no such value
   */
   ...
   * @param lo the left endpoint of the subarray (inclusive)
   * @param hi the right endpoint of the subarray (inclusive)
   * @return the population variance in the subarray <tt>a[lo..hi]</tt>; <tt>Double.NaN</tt> if no
   *     such value
   */
   ...
   *
   * @param a the array
   * @return the sample standard deviation in the array <tt>a[]</tt>; <tt>Double.NaN</tt> if no such
   *     value
   */
   ...
   * @param lo the left endpoint of the subarray (inclusive)
   * @param hi the right endpoint of the subarray (inclusive)
   * @return the sample standard deviation in the subarray <tt>a[lo..hi]</tt>; <tt>Double.NaN</tt>
   *     if no such value
   */
   ...
   *
   * @param a the array
   * @return the population standard deviation in the array; <tt>Double.NaN</tt> if no such value
   */
   ...
   *
   * @param a the array
   * @return the sum of all values in the array <tt>a[]</tt>; <tt>0.0</tt> if no such value
   */
   ...
   * @param lo the left endpoint of the subarray (inclusive)
   * @param hi the right endpoint of the subarray (inclusive)
   * @return the sum of all values in the subarray <tt>a[lo..hi]</tt>; <tt>0.0</tt> if no such value
   */
  ...
  /**
   * Unit tests <tt>StdStats</tt>. Convert command-line arguments to array of doubles and call
   * various methods.
   */
