...
/**
 * The <tt>RectHV</tt> class is an immutable data type to encapsulate a two-dimensional axis-aligned
 * rectagle with real-value coordinates. The rectangle is <em>closed</em>&mdash;it includes the
 * points on the boundary.
 *
 * <p>For additional documentation, see <a href="http://algs4.cs.princeton.edu/12oop">Section
...
public final class RectHV {
   ...
   * @throws IllegalArgumentException if any of <tt>xmin</tt>, <tt>xmax</tt>, <tt>ymin</tt>, or
   *     <tt>ymax</tt> is <tt>Double.NaN</tt>.
   * @throws IllegalArgumentException if <tt>xmax</tt> &lt; <tt>xmin</tt> or <tt>ymax</tt> &lt;
   *     <tt>ymin</tt>.
   */
   ...
   * @return <tt>true</tt> if this rectangle intersect the argument rectagnle at one or more points,
   ...
   *
   * @param p the point
   * @return <tt>true</tt> if this rectangle contain the point <tt>p</tt>, possibly at the boundary;
   ...
   *
   * @param p the point
   * @return the Euclidean distance between the point <tt>p</tt> and the closest point on this
   ...
   *
   * @param p the point
   * @return the square of the Euclidean distance between the point <tt>p</tt> and the closest point
   ...
   * @return <tt>true</tt> if this rectangle equals <tt>other</tt>; <tt>false</tt> otherwise
   */
  @Override
   ...
   *
   * @return a string representation of this rectangle, using the format <tt>[xmin, xmax] x [ymin,
   *     ymax]</tt>
   */
  @Override
