...
/**
 * The <tt>DirectedEulerianCycle</tt> class represents a data type for finding an Eulerian cycle or
...
public class DirectedEulerianCycle {
  ...
  public DirectedEulerianCycle(Digraph G) {
    ...
    // greedily add to putative cycle, depth-first algo.search style
   ...
   *
   * @return <tt>true</tt> if the digraph has an Eulerian cycle; <tt>false</tt> otherwise
   */
