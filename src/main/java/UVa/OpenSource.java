...
// Input
//     The input contains several test cases, each one ending with a line that starts with the digit
// 1. The last
...
// Output
//     For each test case, output a summary of each project sheet. The summary is one line with the
// name
//     of the project followed by the number of students who signed up. These lines should be
// printed in
//     decreasing order of number of signups. If two or more projects have the same number of
// signups, they
...
public class OpenSource {
  ...
  public static void main(String args[]) throws Exception {
    ...
    while (!(line = br.readLine()).equals("0")) {
      ...
      while (!(line = br.readLine()).equals("uva")) {
