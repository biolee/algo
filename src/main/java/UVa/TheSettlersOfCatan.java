...
// path. Therefore, determining the longest road is not trivial (although human players usually see
// it
// immediately).
...
// The longest road is defined as the longest path within the network that doesn’t use an edge
// twice.
// Nodes may be visited more than once, though.

// Input
//     The input file will contain one or more test cases.
//     The first line of each test case contains two integers: the number of nodes n (2 ≤ n ≤ 25)
// and the
//     number of edges m (1 ≤ m ≤ 25). The next m lines describe the m edges. Each edge is given by
// the
//     numbers of the two nodes connected by it. Nodes are numbered from 0 to n − 1. Edges are
// undirected.
...
// source:
// https://github.com/morris821028/UVa/blob/master/volume005/539%20-%20The%20Settlers%20of%20Catan.cpp
