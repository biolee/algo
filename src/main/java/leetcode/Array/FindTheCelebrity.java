...
// are allowed to do
// is to ask questions like: "Hi, A. Do you know B?" to get information of whether A knows B. You
// need to find out the
// celebrity (or verify there is not one) by asking as few questions as possible (in the asymptotic
// sense).
...
public class FindTheCelebrity extends Relation {
  ...
  public int findCelebrity(int n) {
    ...
    for (int i = 0; i < n; i++) {
      ...
      // if the candidate knows the current person or the current person does not know the
      // candidate, return -1 (candidate is not a celebrity)
