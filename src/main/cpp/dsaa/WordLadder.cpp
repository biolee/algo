...
map<string,vector<string>> computeAdjacentWordsSlow( const vector<string> & words )
{
...
map<string,vector<string>> computeAdjacentWordsMedium( const vector<string> & words )
{
    map<string,vector<string>> adjWords;
